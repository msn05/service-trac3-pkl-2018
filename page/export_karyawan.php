...
$excel->getProperties()->setCreator('Muhamamad Satrio')
...
$excel->setActiveSheetIndex(0)->setCellValue('B3', "Kode Karyawan"); // Set kolom B3 dengan tulisan "NIS"
...
$excel->setActiveSheetIndex(0)->setCellValue('F3', "Telephone"); // Set kolom F3 dengan tulisan "ALAMAT"
