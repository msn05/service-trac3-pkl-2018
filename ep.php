...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', "Data Pelanggan"); // Set kolom A1 dengan tulisan "DATA SISWA"
$objPHPExcel->getActiveSheet()->mergeCells('A1:H1'); // Set Merge Cell pada kolom A1 sampai F1
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B3', "Kode Pelanggan"); // Set kolom B3 dengan tulisan "NIS"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C3', "Nama Pelanggan"); // Set kolom C3 dengan tulisan "NAMA"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D3', "Alamat"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E3', "Nomor KTP"); // Set kolom E3 dengan tulisan "TELEPON"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F3', "Jenis Kelamin"); // Set kolom E3 dengan tulisan "TELEPON"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G3', "Telephone"); // Set kolom F3 dengan tulisan "ALAMAT"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H3', "Alamat Email"); // Set kolom F3 dengan tulisan "ALAMAT"
...
while($data = mysqli_fetch_array($tampil)){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data['kustom_id']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['kustom_nama']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['alamat']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data['no_ktp']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data['kustom_jk']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $data['kustom_hp']);
...
$objPHPExcel->getActiveSheet(0)->setTitle("Laporan Data Pelanggan");
