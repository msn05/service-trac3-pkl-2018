...
$objPHPExcel->getProperties()->setCreator('MSN')
             ...
             ->setTitle("Data Oli")
             ->setSubject("Oli")
             ->setDescription("Laporan Semua Data Oli")
             ->setKeywords("Data Oli");
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', "Data Oli"); // Set kolom A1 dengan tulisan "DATA SISWA"
$objPHPExcel->getActiveSheet()->mergeCells('A1:I1'); // Set Merge Cell pada kolom A1 sampai F1
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B3', "Kode Oli"); // Set kolom B3 dengan tulisan "NIS"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C3', "Nama Oli"); // Set kolom C3 dengan tulisan "NAMA"
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F3', "Harga"); // Set kolom F3 dengan tulisan "ALAMAT"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G3', "Jumlah Oli"); // Set kolom F3 dengan tulisan "ALAMAT"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H3', "Tanggal Masuk"); // Set kolom F3 dengan tulisan "ALAMAT"
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I3', "Status"); // Set kolom F3 dengan tulisan "ALAMAT"
...
while($data = mysqli_fetch_array($tampil)){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data['id_oli']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['nama_oli']);
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, 'Rp.'.number_format($data['harga'],2,',','.').'');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $data['jmlh_oli']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $data['tgl_doli']);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$numrow, $data['status']);
...
$objPHPExcel->getActiveSheet(0)->setTitle("Laporan Data Oli");
...
header('Content-Disposition: attachment; filename="Data Oli.xls"');
